...
def analyze_and_fix(lines):
    ...
    for _ in range(30):
        ...
        try:
            ...
            # Если AST спарсился, значит синтаксис цел. Можно проверять переменные.
            ...
            # Если не смогли починить — больше ничего не вырезаем! Просто выходим.
            ...
            if "unterminated string literal" in err_msg or "eol while scanning string literal" in err_msg:
                ...
                # Дозакрываем скобку, если кавычка съела её
