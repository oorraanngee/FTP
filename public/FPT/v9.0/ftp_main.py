...
def main():
    ...
    if latest_version != CURRENT_VERSION:
        print(f"{COLORS['ORANGE']}ВНИМАНИЕ: Вышла версия {latest_version} пожалуйста обновите утилиту для корректной работы. Для этого зайдите на fix-this-python.vercel.app и скачайте версию {latest_version}.{COLORS['RESET']}")
