...
def send_error_log(log_text):
    ...
    try:
        # Использование timezone-aware datetime для устранения DeprecationWarning
        ...
        print(f"{COLORS['RED']}Не удалось отправить лог. Возможно, блокировка или проблема с интернетом.\nОшибка: {ex}{COLORS['RESET']}")
